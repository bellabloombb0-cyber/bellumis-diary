    ...
    <main className="min-h-screen bg-[#eee7f5] px-5 py-10 text-ink sm:px-10 sm:py-14 lg:px-16">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-12 overflow-hidden rounded-[2rem] border-8 border-mist bg-mist shadow-xl shadow-lilac/20 sm:mt-14">
          ...
          <img src="/postcards/a-little-piece-of-portugal.svg?v=3" alt="Digital postcard with a soft Portugal-inspired landscape and a message about finding home" className="block w-full" />
        </section>

        <div className="mt-9 text-center">
          <a href="/postcards/a-little-piece-of-portugal.svg?v=3" download="a-little-piece-of-portugal.svg" className="inline-flex rounded-full bg-lilac-deep px-7 py-3.5 text-sm font-bold text-mist transition hover:-translate-y-0.5 hover:bg-ink">
